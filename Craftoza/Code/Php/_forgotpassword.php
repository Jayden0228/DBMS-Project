...
<div class="box center" style="top:23vh;">
    ...
    <form action="index.php" method="post" class="center2" onsubmit="return validateFgtpwd(this)"><br>
        <label for="Email">Email</label><br>
        <input type="email" id="email" name="Email" class="inp" required><br><br>
        <input type="submit" value="GET OTP" class="button2" name="forgotpwd"><br><br>
    </form>
